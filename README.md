...
- Adjustable settings: Tmin and Tmax via buttons [<] and [>], with flashing display feedback:
  - [<] (blue button) must be held for at least 2 seconds to adjust Tmin
  - [>] (red button) must be pressed for less than 2 seconds to adjust Tmax  
- Values save automatically after 5 seconds of inactivity.
...
3. Adjust Tmin/Tmax with [<] and [>] as described:
   - Hold [<] (blue button) for at least 2 seconds to adjust Tmin
   - Press [>] (red button) for less than 2 seconds to adjust Tmax
